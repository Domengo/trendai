  ...
  return (
    <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4 mt-4">
      <div className="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
          <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Influencers</p>
          <p className="text-lg font-semibold text-gray-700 dark:text-gray-200">{influencers?.length}</p>
        </div>
      </div>
      <div className="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
          <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Active Campaigns</p>
      ...
      <div className="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
          <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Submissions</p>
          <p className="text-lg font-semibold text-gray-700 dark:text-gray-200">{submissions?.length}</p>
        </div>
      </div>
      <div className="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
          <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Pending Approvals</p>
          <p className="text-lg font-semibold text-gray-700 dark:text-gray-200">
